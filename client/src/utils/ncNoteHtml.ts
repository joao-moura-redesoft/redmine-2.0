// Conversão HTML ↔ Markdown para as notas do Nextcloud (QuickNotes guarda `content`
// em HTML; nosso editor trabalha com markdown). Isolado da camada de API para poder
// ser testado (ver ncNoteHtml.test.ts) e reutilizado.
