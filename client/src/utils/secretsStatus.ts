...
const EMPTY: SecretsStatus = { ad: false, ai: { anthropic: false, openai: false, gemini: false }, totpCount: 0 };
...
export function getSecretsStatus(): SecretsStatus { return cache; }
